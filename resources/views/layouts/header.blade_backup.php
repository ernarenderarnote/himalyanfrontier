				...
				<div class="nav_w3ls mx-lg-auto">
					<nav class="custom_nav">
						...
						<ul class="menu mx-lg-auto">
                            ...
                            <li>
                                <a href="{{url('advanced-search?itinerary_type=fixed_departure')}}">Fixed Departures</a>
                                <ul class="dropdown-menu">
                                    @foreach($menus->fixedDeparture() as $diparture)
                                            
                                        <li><a href="{{url('advanced-search?activity='.$diparture->slug)}}">{{ $diparture->title }}</a></li>
